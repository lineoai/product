...
import { Loader, MoreHorizontal, Wand2Icon } from "lucide-react";
...
const ConversationIdView = ({ conversationId }: ConversationIdViewProps) => {
  ...
  const [isEnahancing, setIsEnhancing] = useState(false);
            ...
            <AIInputToolbar>
              <AIInputTools>
                ...
                onClick={handleEnhanceResponse}
                  disabled={conversation?.status === "resolved" || isEnahancing || !form.formState.isValid}
                >
                  {isEnahancing ? (
                    <>
                      Enhancing
